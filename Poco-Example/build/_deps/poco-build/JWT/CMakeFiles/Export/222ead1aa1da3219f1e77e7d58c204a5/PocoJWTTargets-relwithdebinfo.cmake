...
set_target_properties(Poco::JWT PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libPocoJWT.86.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libPocoJWT.86.dylib"
  )

list(APPEND _cmake_import_check_targets Poco::JWT )
list(APPEND _cmake_import_check_files_for_Poco::JWT "${_IMPORT_PREFIX}/lib/libPocoJWT.86.dylib" )
