...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "poco-1.11.6-release"
  WORKING_DIRECTORY "/Users/hayde/Desktop/Code/CMake/Poco-Example/build/_deps/poco-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "poco-1.11.6-release")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("poco-1.11.6-release" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/poco-1.11.6-release")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/hayde/Desktop/Code/CMake/Poco-Example/build/_deps/poco-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/hayde/Desktop/Code/CMake/Poco-Example/build/_deps/poco-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
